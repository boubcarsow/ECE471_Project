...
# 1 "./ADC_Temp_Module.h" 1
# 34 "./ADC_Temp_Module.h"
# 1 "./project.h" 1
# 15 "./project.h"
# 1 "./configuration.h" 1
...
char DHT11_ReadData();
# 9 "ADC_Temp_Module.c" 2
# 32 "ADC_Temp_Module.c"
void init_DHT11()
{
    TRISAbits.TRISA0 = 0;
    LATAbits.LA0 = 0;
    _delay((unsigned long)((18)*(80000/4000.0)));
    LATAbits.LA0 = 1;
    _delay((unsigned long)((20)*(80000/4000000.0)));
    TRISAbits.TRISA0 = 1;
}
...
char DHT11_ReadData()
{
    ...
    {
        while(!(PORTAbits.RA0 & 1));
        _delay((unsigned long)((30)*(80000/4000000.0)));
        if(PORTAbits.RA0 & 1)
            data = ((data<<1) | 1);
        else
            data = (data<<1);
