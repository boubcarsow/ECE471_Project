...
void Lcd_Cmd(char a)
{
 ...
 Lcd_Port(a);
 PORTDbits.RD3 = 1;
        _delay((unsigned long)((4)*(80000/4000.0)));
        PORTDbits.RD3 = 0;
}
...
{
  Lcd_Port(0x00);
   _delay((unsigned long)((20)*(80000/4000.0)));
  Lcd_Cmd(0x03);
 _delay((unsigned long)((5)*(80000/4000.0)));
  Lcd_Cmd(0x03);
 _delay((unsigned long)((11)*(80000/4000.0)));
  Lcd_Cmd(0x03);
...
void Lcd_Write_Char(char a)
{
   ...
   Lcd_Port(y>>4);
   PORTDbits.RD3 = 1;
   _delay((unsigned long)((40)*(80000/4000000.0)));
   PORTDbits.RD3 = 0;
   Lcd_Port(temp);
   PORTDbits.RD3 = 1;
   _delay((unsigned long)((40)*(80000/4000000.0)));
